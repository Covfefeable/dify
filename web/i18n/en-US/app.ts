const translation = {
  ...
  export: 'Export DSL',
  copyToTenant: {
    title: 'Copy to other workspace',
    name: 'Workflow Name',
    namePlaceholder: 'Please enter workflow name',
    targetWorkspace: 'Target Workspace',
    targetWorkspacePlaceholder: 'Please select target workspace',
    done: 'Copied to workspace successfully',
    failed: 'Copy to workspace failed',
    fieldRequired: 'Name and Workspace are required',
  },
