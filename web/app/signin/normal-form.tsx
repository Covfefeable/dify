    ...
    <>
      <div className="mx-auto mt-8 w-full">
        {isInviteLink
          ...
          : (
              <div className="mx-auto w-full">
                <h2 className="text-text-primary title-4xl-semi-bold">{systemFeatures.branding.login_page_title || t('pageTitle', { ns: 'login' })}</h2>
                {!systemFeatures.branding.enabled && <p className="mt-2 text-text-tertiary body-md-regular">{t('welcome', { ns: 'login' })}</p>}
              </div>
            )}
        <div className="relative">
